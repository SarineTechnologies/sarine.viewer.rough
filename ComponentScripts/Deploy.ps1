...
if($envType -eq "prod"){
	$siteUri = "http://viewer-api.sarine.com/cache/v2/atom/sarine.viewer.rough"
}
else{
	$siteUri = "http://viewer-api-$envId.$envName.sarine.com/cache/v2/atom/sarine.viewer.rough"
}
